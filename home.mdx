...
<div className="relative w-full flex items-center justify-center" style={{ height: '24rem', overflow: 'hidden'}}>
  ...
  <div style={{ position: 'absolute', textAlign: 'center', padding: '0 1rem' }}>
    ...
    >
      Welcome to the Smokeball Developer page!
    </div>
    <p
    ...
    <button
      type="button"
      className="hidden w-full lg:flex items-center text-sm leading-6 rounded-full py-3 px-6 text-white bg-[#FF6B3D] hover:bg-[#ff825c] transition-colors duration-200 relative"
