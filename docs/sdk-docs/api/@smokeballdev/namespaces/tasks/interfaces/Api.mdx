...
> **all**(`matterId?`): `Promise`\<[`Task`](Task.md)[]\>
...
> **create**(`request`): `Promise`\<[`Task`](Task.md)\>
...
> **delete**(`id`): `Promise`\<[`Task`](Task.md)\>
...
[`OpenNewRequest`](OpenNewRequest.md)
...
> **update**(`request`): `Promise`\<[`Task`](Task.md)\>
