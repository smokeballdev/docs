...
> `optional` **citizenshipDetails**: [`CitizenshipDetails`](CitizenshipDetails.md)
...
> `optional` **deathDetails**: [`DeathDetails`](DeathDetails.md)
...
> `optional` **identificationDetails**: [`IdentificationDetails`](IdentificationDetails.md)
...
> `optional` **passportDetails**: [`PassportDetails`](PassportDetails.md)
...
> `optional` **utbmsDetails**: [`UtbmsDetails`](UtbmsDetails.md)
