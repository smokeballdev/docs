...
> **create**(`request`): `Promise`\<[`Matter`](Matter.md)\>
...
[`CreateMatterRequest`](CreateMatterRequest.md)

the create request.

#### Returns

`Promise`\<[`Matter`](Matter.md)\>
...
> **get**(`matterId?`): `Promise`\<[`Matter`](Matter.md)\>
...
> **getMany**(`request`): `Promise`\<[`GetMattersResponse`](GetMattersResponse.md)\>
...
[`GetMattersRequest`](GetMattersRequest.md)

the matters to retrieve.

#### Returns

`Promise`\<[`GetMattersResponse`](GetMattersResponse.md)\>
