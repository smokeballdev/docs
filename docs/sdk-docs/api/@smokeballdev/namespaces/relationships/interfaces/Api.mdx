...
> **add**(`request`): `Promise`\<[`Relationship`](Relationship.md)\>
...
[`AddRelationshipRequest`](AddRelationshipRequest.md)
...
> **get**(`roleId`): `Promise`\<[`Relationships`](Relationships.md)\>
...
`Promise`\<[`Relationships`](Relationships.md)\>
...
> **remove**(`roleId`, `id`): `Promise`\<[`Relationships`](Relationships.md)\>
...
> **update**(`request`): `Promise`\<[`Relationship`](Relationship.md)\>
...
[`UpdateRelationshipRequest`](UpdateRelationshipRequest.md)
