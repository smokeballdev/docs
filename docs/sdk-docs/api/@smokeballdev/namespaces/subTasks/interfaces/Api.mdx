...
> **all**(`taskId`): `Promise`\<[`SubTask`](SubTask.md)[]\>
...
> **create**(`request`): `Promise`\<[`SubTask`](SubTask.md)\>
...
> **delete**(`id`, `taskId`): `Promise`\<[`SubTask`](SubTask.md)\>
...
> **get**(`id`, `taskId`): `Promise`\<[`SubTask`](SubTask.md)\>
...
> **update**(`request`): `Promise`\<[`SubTask`](SubTask.md)\>
...
[`UpdateSubTaskRequest`](UpdateSubTaskRequest.md)
