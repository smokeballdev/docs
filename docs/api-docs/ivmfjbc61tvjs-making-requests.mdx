...
To act on behalf of a certain user simply supply the `UserId` header with your requests. The value must be that of a [User](/api-reference/firm/get-firm-user-mappings) in the firm.
