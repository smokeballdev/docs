...
- **Matters**: Matter access can now be restricted by `UserId` when using Client Credentials grant (see [Acting on behalf of a user](ivmfjbc61tvjs-making-requests#31-acting-on-behalf-of-a-user)).
- **Leads**: Restricted leads API to Grow and Prosper tiered clients.
- **Files**: File access can now be restricted by `UserId` when using Client Credentials grant (see [Acting on behalf of a user](ivmfjbc61tvjs-making-requests#31-acting-on-behalf-of-a-user)).
</Update>
