...
Scopes are requested via the `scope` parameter (space-delimited) when authorizing with the [Authorization Code Grant](/docs/api-docs/2t26gcuuqf1wk-authorization-code-grant), or when requesting a token with the [Client Credentials Grant](/docs/api-docs/h72024p76i8e1-client-credentials-grant).
