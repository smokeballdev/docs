...
This guide is intended for firms who want to share access to their private Smokeball app with external developers or partners. If you are a Smokeball Partner looking to develop marketplace apps, please refer to our [Partner documentation](/docs/platform-docs/4f56d789e123f-creating-an-app).
...
3. Click "Share App" and enter an **existing** partner's email address
